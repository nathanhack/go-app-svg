...
func (nNA *nameValueAttribute) Name() string {
	return nNA.N
}

func (nNA *nameValueAttribute) Value() any {
	return nNA.V
}

func If(value bool, trueAttr svg.Attribute, falseAttr svg.Attribute) svg.Attribute {
	if value {
		return trueAttr
	}
	return falseAttr
...
func IfSlice(value bool, trueAttr []svg.Attribute, falseAttr []svg.Attribute) []svg.Attribute {
	if value {
		return trueAttr
	}
	return falseAttr
